# Operator Quickstart — Wholesale of solid, liquid and gaseous fuels and related products

Shortest path from clone to a verified local dry-run for **ISIC 4661** (`cloud-itonami-isic-4661`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4661.git
cd cloud-itonami-isic-4661
```
...
- Blueprint governor key: `fuel-depot-operations-governor`
- Likely source path: `fueldepot.governor.cljc`

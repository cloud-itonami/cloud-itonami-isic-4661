# Business Model: Wholesale of solid, liquid and gaseous fuels and related products
...
- ISIC Rev.5: `` — Wholesale of solid, liquid and gaseous fuels and related products
- Domain: `:downstream/fuel-wholesale-depot`
- Social impact: :safety :environmental-protection :transparency
- Actor: `:fuel-depot-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :downstream/fuel-wholesale-depot — who wants
...
Capability stack (required): :robotics :identity :forms :dmn :bpmn :audit-ledger :retail.
...
One managed tenant (:downstream/fuel-wholesale-depot):
...
- Do not bypass the `:fuel-depot-operations-governor` for production decisions.
